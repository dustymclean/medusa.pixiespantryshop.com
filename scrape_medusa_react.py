"""
ULTIMATE Medusa Scraper for React:
- Auto-login to medusadistribution.com
- Scrape ALL in-stock items with full details
- Export to medusa_products.json (React-ready)
"""
import asyncio
